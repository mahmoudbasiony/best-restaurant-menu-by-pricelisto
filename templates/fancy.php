...
if ( ! is_null( $key ) && isset( $menu[ $key ] ) ) :
	 ...
	 */
	echo brm_renders_fancy_frontend_menu( $menu[ $key ], $currency ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Output is safely escaped within brm_renders_fancy_frontend_menu.
else :
	?>
